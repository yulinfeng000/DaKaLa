    ...
    try:
        if is_scheduler_exec(config, STU_ID):
            if config.get("application_start_day") is not None:
                application_start_day_elem = driver.find_element_by_name("sF21912_3")
            ...
            if config.get("application_start_time") is not None:
                application_start_time_elem = driver.find_element_by_name("sF21912_4")
            ...
            if config.get("application_end_time") is not None:
                application_end_time_elem = driver.find_element_by_name("sF21912_6")
            ...
            if config.get("application_location") is not None:
                application_location_elem = driver.find_element_by_name("sF21912_1")
        ...
        try:
            ...
            vc_image_path = os.path.abspath(f"{PIC_LOCATION}/{STU_ID}_img.png")
